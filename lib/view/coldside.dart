...
class coldSide extends StatefulWidget {
  const coldSide({Key? key}) : super(key: key);

  @override
  State<coldSide> createState() => _coldSideState();
}

class _coldSideState extends State<coldSide> {
  // Variables
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        // Temperature
                        wd.putText("25°C", 40.0, 1.5, mc.primaryBlue)
                      ],
                    ),
                  ),
                ),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        // Humidity
                        wd.putText("30% ", 40.0, 1.5, mc.primaryGreen)
                      ],
                    ),
                  ),
                ),
